    ...
    def generate_application(self, user_id: str, job_id: str) -> TestApplication:
        ...
        return TestApplication(
            ...
            status=random.choice(
                ["applied", "reviewing", "interviewing", "offered", "rejected"]
            ),
...
class TestDataManager:
    ...
    def __init__(
        self, database_url: str = "mongodb://localhost:27017/test_buzz2remote"
    ):
        self.database_url = database_url
        self.generator = TestDataGenerator()
        self.test_data = {"users": [], "jobs": [], "companies": [], "applications": []}
        ...
        for collection in collections:
            try:
                ...
                if collection == "users":
                    ...
                    await db[collection].delete_many(
                        {"name": {"$in": self.generator.companies}}
                    )
                else:
                    await db[collection].delete_many({})
    ...
    async def generate_test_data(self, db):
        ...
        for i in range(50):
            ...
            job_dict["posted_date"] = datetime.utcnow() - timedelta(
        ...
        for i in range(30):
            ...
            app_dict["applied_date"] = datetime.utcnow() - timedelta(
    ...
    def get_test_application(self, index: int = 0) -> Optional[Dict]:
        ...
        if self.test_data["applications"] and index < len(
            self.test_data["applications"]
        ):
...
def main():
    ...
    parser.add_argument(
        "--database",
        default="mongodb://localhost:27017/test_buzz2remote",
        help="Database URL",
    )
