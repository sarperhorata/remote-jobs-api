...
class TestApplicationsAPI:
    ...
    def test_applications_endpoints_exist(self):
        ...
        assert response.status_code in [
            ...
            403,
            422,
        ], "Apply endpoint should exist and require auth"
        ...
        assert response.status_code in [
            401,
            403,
        ], "My applications endpoint should exist and require auth"
    ...
    def test_applications_validation(self):
        ...
        assert response.status_code in [
            ...
            403,
            422,
        ], "Should validate application data"
    ...
    def test_applications_check_applied_endpoint(self):
        ...
        assert response.status_code in [
            401,
            403,
        ], "Check applied endpoint should require auth"
    ...
    def test_applications_applied_jobs_endpoint(self):
        ...
        assert response.status_code in [
            401,
            403,
        ], "Applied jobs endpoint should require auth"
...
class TestApplicationsIntegration:
    ...
    def test_applications_router_included(self):
        ...
        ), "Applications router should be included with correct prefix"
