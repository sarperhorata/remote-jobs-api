...
class UserApplicationService:
    ...
    async def create_application(self, application_data: UserApplicationCreate) -> UserApplicationResponse:
    ...
    async def get_user_application(self, user_id: str, job_id: str) -> Optional[UserApplicationResponse]:
    ...
    async def get_application_by_id(self, application_id: str) -> Optional[UserApplicationResponse]:
