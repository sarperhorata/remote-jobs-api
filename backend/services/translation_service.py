...
class TranslationService:
    ...
    async def detect_language(self, text: str) -> Tuple[str, float]:
        ...
        try:
            if LANGDETECT_AVAILABLE:
                ...
                return detected.lang if detected and hasattr(detected, 'lang') else "en", confidence
            else:
                return "en", 0.3
        except Exception as e:
    ...
    async def translate_text(self, text: str, target_lang: str = "tr", source_lang: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            translated_text = translation.text if translation and hasattr(translation, 'text') else text
    ...
    async def validate_translation_quality(self, original: str, translated: str) -> Dict[str, Any]:
        ...
        try:
            ...
            for field in ["requirements", "benefits"]:
                if job_data.get(field):
                    field_result = await self.translate_text(job_data[field][:300], "en")
    ...
    async def batch_translate_jobs(self, jobs: List[Dict[str, Any]], batch_size: int = 10) -> List[Dict[str, Any]]:
