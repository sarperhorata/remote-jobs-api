...
class JobTitleParser:
    ...
    def __init__(self):
        ...
        self.categories = {
            "Technology": [
                ...
                "data scientist", "machine learning", "ai", "ml", "analyst", "qa", "test",
                "frontend", "backend", "full stack", "mobile", "ios", "android", "web",
                "software", "hardware", "system", "network", "security", "cyber",
                "cloud", "aws", "azure", "gcp", "database", "sql", "nosql"
            ],
            "Management": [
                "manager", "director", "head", "lead", "chief", "vp", "c-level", "executive",
                "supervisor", "coordinator", "administrator", "superintendent"
            ],
            "Design": [
                "designer", "ux", "ui", "graphic", "visual", "creative", "art", "brand",
                "illustrator", "animator", "photographer", "video", "motion"
            ],
            "Marketing": [
                "marketing", "growth", "seo", "sem", "ppc", "social media", "content",
                "brand", "advertising", "campaign", "analytics", "digital marketing"
            ],
            "Sales": [
                "sales", "account", "business development", "revenue", "partnership",
                "customer success", "client", "territory", "inside sales", "outside sales"
            ],
            "Finance": [
                "finance", "accounting", "controller", "treasurer", "auditor", "analyst",
                "investment", "banking", "risk", "compliance", "tax"
            ],
            "HR": [
                "hr", "human resources", "recruiter", "talent", "people", "benefits",
                "compensation", "training", "development", "diversity", "inclusion"
            ],
            "Operations": [
                "operations", "logistics", "supply chain", "procurement", "vendor",
                "facilities", "maintenance", "quality", "process", "efficiency"
            ],
            "Customer Service": [
                "customer service", "support", "help desk", "technical support",
                "client relations", "customer experience", "service desk"
            ],
            "Legal": [
                "legal", "lawyer", "attorney", "counsel", "paralegal", "compliance",
                "regulatory", "contract", "intellectual property", "litigation"
            ]
        }
        
        # Job levels
        self.levels = {
            "entry": ["junior", "jr", "entry", "associate", "assistant", "trainee", "intern"],
        ...
        self.level_keywords = ["senior", "sr", "junior", "jr", "lead", "principal", "staff"]
        
        # Common skills to extract
        self.skills = [
            "javascript", "python", "java", "react", "node", "angular", "vue", "typescript",
            "php", "ruby", "go", "rust", "kotlin", "swift", "c++", "c#", "sql", "mongodb",
            "postgresql", "mysql", "redis", "docker", "kubernetes", "aws", "azure", "gcp",
            "git", "jenkins", "jira", "figma", "sketch", "adobe", "photoshop", "illustrator"
        ]
        
        # Work types
        self.work_types = ["remote", "hybrid", "on-site", "full-time", "part-time", "contract", "freelance"]
        
        # Common departments
        self.departments = [
            "engineering", "product", "marketing", "sales", "finance", "hr", "operations",
            "legal", "customer service", "design", "data", "security", "devops"
        ]
    ...
    def _categorize_title(self, title: str) -> str:
        ...
        tech_skills = ["react", "javascript", "python", "java", "node", "angular", "vue", "typescript", "ruby", "rails", "php", "go", "rust", "kotlin", "swift"]
    ...
    def _extract_location(self, title: str) -> Optional[str]:
        ...
        location_names = [
            ...
            'new york', 'london', 'berlin', 'paris', 'madrid', 'rome', 'amsterdam',
            ...
            'philadelphia', 'pa', 'california', 'ca', 'texas', 'tx', 'florida', 'fl',
            'england', 'scotland', 'wales', 'ireland', 'emea', 'apac', 'latam'
        ]
        ...
        for pattern in location_patterns:
            ...
            if match:
                ...
                skip_words = ['full', 'time', 'part', 'contract', 'freelance', 'remote', 'hybrid', 'onsite']
                ...
                job_words = ['director', 'manager', 'developer', 'engineer', 'designer', 
                           'analyst', 'coordinator', 'executive', 'specialist', 'associate',
                           'assistant', 'intern', 'trainee', 'lead', 'head', 'chief',
                           'team', 'project', 'product', 'business', 'marketing', 'sales',
                           'python', 'javascript', 'react', 'node', 'java', 'ruby', 'php']
                
                if location_lower not in job_words:
                    # Additional check: if it contains common location words
                    location_indicators = ['city', 'town', 'state', 'country', 'region', 'area', 'pa', 'ca', 'tx', 'fl', 'ny']
                    if any(indicator in location_lower for indicator in location_indicators):
                        return location
                    ...
                    if re.match(r'^[A-Z][a-z]+(?:\s+[A-Z][a-z]+)*$', location):
                        ...
                        common_titles = ['senior', 'junior', 'lead', 'principal', 'staff', 'associate', 'assistant']
