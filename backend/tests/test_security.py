...
from backend.middleware.rate_limiting import rate_limiter, brute_force_protection
...
class TestRateLimiting:
    ...
    def test_brute_force_protection(self):
        ...
        assert brute_force_protection.is_blocked(test_ip) == False
        
        # Record failed attempts
        for i in range(5):
            brute_force_protection.record_failed_attempt(test_ip, test_ip)
        
        # Should be blocked after 5 failed attempts
        assert brute_force_protection.is_blocked(test_ip) == True
