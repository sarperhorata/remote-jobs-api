...
if not TELEGRAM_ENABLED:
    logger.warning(
        "TELEGRAM_BOT_TOKEN environment variable is not set. Telegram bot features will be disabled."
    )
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "Hi! I am your Remote Jobs bot. Use /help to see available commands."
    )
