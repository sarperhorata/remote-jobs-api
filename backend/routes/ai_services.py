...
async def get_top_job_matches(
    ...
    try:
        ...
        # Get top matches
        top_matches = job_matcher.get_top_matches(
            resume_data, jobs_data, limit, min_score
        )
...
async def get_job_recommendations(
    ...
    try:
        ...
        # Get recommendations
        recommendations = job_matcher.get_resume_recommendations(
            resume_data, jobs_data, limit
        )
...
async def comprehensive_analysis(
    ...
    try:
        ...
        recommendations = job_matcher.get_resume_recommendations(
            resume_data, jobs_data, limit=10
        )
