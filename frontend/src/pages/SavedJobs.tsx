...
import { Bookmark, ExternalLink, MapPin, DollarSign, Calendar, Briefcase } from 'lucide-react';
      ...
      <Layout>
        <div className="container mx-auto px-4 py-16 text-center">
          <div className="max-w-md mx-auto">
            <Bookmark className="w-16 h-16 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Please Login</h1>
            <p className="text-gray-600 dark:text-gray-300">You need to be logged in to view your saved jobs.</p>
          </div>
        </div>
      </Layout>
    );
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">Loading your saved jobs...</p>
          </div>
        ) : error ? (
          <div className="text-center py-12">
            <div className="text-red-500 mb-4">⚠️</div>
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Error Loading Saved Jobs</h2>
              ...
              <div key={job._id || job.id} className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-600 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2 ml-4">
                    <button 
                      onClick={() => removeSavedJob(job._id || job.id || '')} 
                      title="Remove from Saved Jobs" 
                      className="p-2 text-blue-500 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-full transition-colors"
                    >
          ...
          <div className="text-center py-12">
            <Bookmark className="w-16 h-16 text-gray-400 dark:text-gray-500 mx-auto mb-4" />
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Saved Jobs Yet</h2>
