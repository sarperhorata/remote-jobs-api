...
class TestCronjobs:
    ...
    async def test_external_api_crawler_job(self):
        ...
        try:
            ...
            with patch(
                "backend.services.external_job_service.crawl_external_apis"
            ) as mock_crawl:
    ...
    def test_wake_up_render_function(self):
        ...
        try:
            with patch("requests.get") as mock_get:
                ...
                assert (
                    "https://buzz2remote-api.onrender.com/api/v1/health" in call_args[0]
                )
    ...
    def test_cronjob_script_execution(self):
        ...
        try:
            ...
            script_path = os.path.join(
                os.path.dirname(__file__), "..", "..", "cron_external_apis.py"
            )
            ...
            with patch("sys.path") as mock_path:
                ...
                with patch(
                    ...
                    spec = importlib.util.spec_from_file_location(
                        "cron_external_apis", script_path
                    )
    ...
    async def test_scheduler_error_handling(self):
        ...
        try:
            ...
            with patch(
                "backend.services.scheduler_service._health_check_job"
            ) as mock_health:
    ...
    async def test_scheduler_performance(self):
        ...
        try:
            ...
            assert (
                startup_time < 5.0
            ), f"Scheduler startup too slow: {startup_time:.2f}s"
            ...
            print(
                f"✅ Scheduler performance: startup={startup_time:.2f}s, memory={memory_increase / 1024 / 1024:.2f}MB"
            )
