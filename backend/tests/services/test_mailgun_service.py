...
class TestMailgunService:
    ...
    def test_send_verification_email(self, mock_send_email, mailgun_service):
        ...
        result = mailgun_service.send_verification_email("test@example.com", "test-token")
    ...
    def test_send_password_reset_email(self, mock_send_email, mailgun_service):
        ...
        result = mailgun_service.send_password_reset_email("test@example.com", "reset-token")
        ...
        assert "https://test.com/reset-password?token=reset-token" in call_args["html_content"]
    ...
    def test_send_new_jobs_email(self, mock_send_email, mailgun_service):
        ...
        jobs = [
            ...
            {"title": "React Developer", "company": "StartupInc", "location": "Istanbul"}
        ]
