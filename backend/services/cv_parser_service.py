...
class CVParserService:
    ...
    def _extract_text_from_doc(self, file_content: bytes, file_extension: str) -> str:
        ...
        try:
            if file_extension == '.docx':
                ...
                raise ValueError("DOC format not supported yet. Please convert to DOCX or PDF.")
    ...
    def _extract_name(self, text: str) -> str:
        ...
        for line in lines[:10]:  # Check first 10 lines
            ...
            if line and len(line) < 50:  # Reasonable name length
                ...
                clean_line = re.sub(r'^(Mr\.|Mrs\.|Ms\.|Dr\.|Prof\.)\s*', '', line, flags=re.IGNORECASE)
    ...
    def _extract_summary(self, text: str) -> str:
        ...
        summary_indicators = ['Summary:', 'Objective:', 'Profile:', 'About:', 'Professional Summary:']
        lines = text.split('\n')
    ...
    def _extract_skills(self, text: str) -> List[str]:
        ...
        skills_indicators = ['Skills:', 'Technical Skills:', 'Programming Languages:', 'Technologies:']
        lines = text.split('\n')
    ...
    def _extract_experience(self, text: str) -> List[Dict[str, str]]:
        ...
        experience_indicators = ['Experience:', 'Work Experience:', 'Employment History:', 'Professional Experience:']
        lines = text.split('\n')
            ...
            for indicator in experience_indicators:
                if indicator.lower() in line.lower():
                    ...
                    for j in range(i + 1, len(lines)):
                        ...
                        if re.match(r'^[A-Z][A-Za-z\s&.,]+$', exp_line) and len(exp_line) < 100:
                            if current_experience:
                                experience.append(current_experience.copy())
                        ...
                        if len(exp_line) > 50 and 'description' not in current_experience:
            ...
            for indicator in education_indicators:
                if indicator.lower() in line.lower():
                    ...
                    for j in range(i + 1, len(lines)):
                        ...
                        if re.match(r'^[A-Z][A-Za-z\s&.,]+$', edu_line) and len(edu_line) < 100:
                            if current_education:
                                education.append(current_education.copy())
                            current_education = {'institution': edu_line}
                        
                        # Look for degree
                        degree_patterns = ['Bachelor', 'Master', 'PhD', 'Doctorate', 'Associate', 'Diploma']
    ...
    def _extract_languages(self, text: str) -> List[str]:
        ...
        for lang in languages:
            ...
            if lang and len(lang) > 1 and len(lang) < 30:
                ...
                lang = re.sub(r'\s*(Native|Fluent|Intermediate|Basic)', '', lang, flags=re.IGNORECASE)
    ...
    def _extract_certifications(self, text: str) -> List[str]:
        ...
        cert_indicators = ['Certifications:', 'Certificates:', 'Professional Certifications:']
        lines = text.split('\n')
