...
class TestUtilsConfigExtended:
    ...
    def test_load_env_config_success(self):
        ...
        try:
            from utils.config import get_env_var, load_env_config
    ...
    def test_config_type_conversion(self):
        ...
        try:
            from utils.config import get_env_bool, get_env_float, get_env_int
    ...
    def test_config_validation_with_schema(self):
        ...
        try:
            from utils.config import ConfigSchema, validate_config_schema

            # Define a test schema
            schema = {
                "database": {"host": str, "port": int, "enabled": bool},
                "api": {"version": str, "timeout": float},
            }
    ...
    def test_config_file_operations(self):
        ...
        try:
            from utils.config import (load_config_file, merge_configs,
                                      save_config)
    ...
    def test_config_environment_detection(self):
        ...
        try:
            from utils.config import (get_environment, is_development,
    ...
    def test_config_path_resolution(self):
        ...
        try:
            from utils.config import get_config_dir, resolve_config_path
    ...
    def test_config_caching_mechanism(self):
        ...
        try:
            from utils.config import clear_config_cache, get_cached_config
    ...
    def test_config_watch_and_reload(self):
        ...
        try:
            from utils.config import reload_config, watch_config_file
