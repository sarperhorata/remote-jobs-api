...
from models.job_multilang import (JobMigrationService, JobMultiLang,
                                  MultiLangText, TranslationService)
# Import the correct models
from models.profile import Profile  # SQLAlchemy model
from models.user import (UserBase, UserCreate, UserInDB,  # Pydantic models
...
class TestMultiLangModels:
    ...
    def test_multilang_text_creation(self):
        ...
        multilang = MultiLangText(original="Hello World", original_lang="en")
    ...
    def test_multilang_text_get_text(self):
        ...
        multilang = MultiLangText(original="Hola Mundo", original_lang="es")
    ...
    def test_multilang_text_add_translation(self):
        ...
        multilang = MultiLangText(original="Test", original_lang="en")
    ...
    def test_job_multilang_creation(self):
        ...
        job_data = {
            ...
            "description": MultiLangText(
                original="We are looking for...", original_lang="en"
            ),
            "company": "TechCorp",
            "location": "Remote",
    ...
    def test_job_multilang_get_localized_job(self):
        ...
        job = JobMultiLang(
            ...
            description=MultiLangText(
                original="Build amazing apps", original_lang="en"
            ),
            company="TechCorp",
            location="Remote",
            apply_url="https://example.com/apply",
    ...
    def test_job_multilang_with_requirements_and_benefits(self):
        ...
        job = JobMultiLang(
            ...
            description=MultiLangText(
                original="Exciting opportunity", original_lang="en"
            ),
            requirements=MultiLangText(original="React, Node.js", original_lang="en"),
            benefits=MultiLangText(
                original="Health insurance, Remote work", original_lang="en"
            ),
            company="WebCorp",
            location="Remote",
