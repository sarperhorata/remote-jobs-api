...
class TestComprehensiveAnalysisRoutes:
    ...
    @patch(
        "services.comprehensive_analysis_service.ComprehensiveAnalysisService.analyze_job_market"
    )
    def test_job_market_analysis_success(
        self, mock_analyze, client: TestClient, auth_headers
    ):
    ...
    @patch(
        "services.comprehensive_analysis_service.ComprehensiveAnalysisService.analyze_skills_demand"
    )
    def test_skill_analysis_success(
        self, mock_analyze, client: TestClient, auth_headers
    ):
    ...
    @patch(
        "services.comprehensive_analysis_service.ComprehensiveAnalysisService.comprehensive_analysis"
    )
    ...
    def test_comprehensive_analysis_missing_resume_data(
        self, client: TestClient, auth_headers
    ):
        """Test comprehensive analysis with missing resume data"""
        response = client.post(
            "/api/v1/ai/comprehensive-analysis",
            json={"jobs_data": [{"id": "1", "title": "Developer"}]},
            headers=auth_headers,
        )
    ...
    def test_job_market_analysis_invalid_filters(
        self, client: TestClient, auth_headers
    ):
    ...
    def test_job_market_analysis_empty_results(
        self, mock_analyze, client: TestClient, auth_headers
    ):
        ...
        response = client.post(
            "/api/v1/ai/comprehensive-analysis",
            json={"resume_data": {"skills": ["Python"]}, "jobs_data": []},
            headers=auth_headers,
        )
    ...
    def test_comprehensive_analysis_authentication_required(self, client: TestClient):
        ...
        endpoints = [("/api/v1/ai/comprehensive-analysis", "POST")]
    ...
    def test_comprehensive_analysis_error_handling(
        self, mock_analyze, client: TestClient, auth_headers
    ):
    ...
    def test_skill_analysis_with_specific_skills(
        self, client: TestClient, auth_headers
    ):
    ...
    def test_job_market_analysis_with_date_range(
        self, mock_analyze, client: TestClient, auth_headers
    ):
