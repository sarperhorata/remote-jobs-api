...
class TestEmailService:
    ...
    def test_email_template_rendering(self):
        ...
        result = render_email_template(
            "job_alert", {"job_title": "Software Engineer", "company_name": "Tech Corp"}
        )
    ...
    def test_email_sending(self, mock_smtp):
        ...
        def send_email(
            to_email: str, subject: str, body: str, smtp_config: Dict = None
        ):
    ...
    def test_bulk_email_sending(self):
        ...
        def send_bulk_emails(
            recipients: list, subject: str, body: str, rate_limit: int = 5
        ):
    ...
    def test_email_unsubscribe_handling(self):
        ...
        def handle_unsubscribe(
            email: str, unsubscribe_token: str, user_preferences: Dict
        ):
