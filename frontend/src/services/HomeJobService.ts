...
const MOCK_JOBS: Job[] = [
  {
    ...
    companyId: '1',
    company: { _id: '1', id: '1', name: 'TechCorp', logo: 'https://via.placeholder.com/150', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  },
  {
    ...
    companyId: '2',
    company: { _id: '2', id: '2', name: 'StartupCo', logo: 'https://via.placeholder.com/150', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  },
  {
    ...
    companyId: '3',
    company: { _id: '3', id: '3', name: 'DataFlow', logo: 'https://via.placeholder.com/150', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
