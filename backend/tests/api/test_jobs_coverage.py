...
class TestJobsCoverage:
    ...
    def test_search_jobs_complex_filters(self, client: TestClient):
        ...
        response = client.get(
            "/api/v1/jobs/search?q=python&work_type=remote&experience=senior"
        )
    ...
    def test_job_search_combined_filters(self, client: TestClient):
        ...
        response = client.get(
            "/api/v1/jobs/search?q=python&work_type=remote&job_type=full-time&experience=mid&salary_range=60000-100000"
        )
    ...
    def test_job_search_salary_range_formats(self, client: TestClient):
        ...
        salary_formats = ["50000-80000", "80000+", "100k-150k", "100000-150000"]
