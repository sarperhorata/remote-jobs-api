...
class ErrorHandlingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        try:
            ...
            return await self._handle_generic_exception(request, exc, start_time, error_id)
    
    async def _handle_http_exception(self, request: Request, exc: HTTPException, start_time: float, error_id: str) -> JSONResponse:
    ...
    async def _handle_generic_exception(self, request: Request, exc: Exception, start_time: float, error_id: str) -> JSONResponse:
    ...
    async def _log_http_exception(self, request: Request, exc: HTTPException, duration: float, error_id: str):
    ...
    async def _log_generic_exception(self, request: Request, exc: Exception, duration: float, error_id: str):
    ...
    async def _log_error_response(self, request: Request, response, start_time: float, error_id: str):
...
def handle_database_error(exc: Exception) -> HTTPException:
    ...
    if "duplicate key" in error_message or "unique constraint" in error_message:
        ...
        return BusinessLogicError("Referenced resource does not exist", "invalid_reference")
