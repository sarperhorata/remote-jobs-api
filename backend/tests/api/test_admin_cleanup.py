...
class TestAdminCleanup:
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_cleanup_unknown_company_with_jobs(
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_cleanup_unknown_company_exception(
        self, mock_get_db, client, mock_db
    ):
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_get_unknown_company_stats_success(
        self, mock_get_db, client, mock_db
    ):
        ...
        mock_jobs.count_documents = AsyncMock(
            side_effect=[10, 5, 3, 2]
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_get_unknown_company_stats_exception(
        self, mock_get_db, client, mock_db
    ):
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_cleanup_extract_company_from_greenhouse_url(
        self, mock_get_db, client, mock_db
    ):
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_cleanup_extract_company_from_lever_url(
        self, mock_get_db, client, mock_db
    ):
    ...
    @patch("backend.routes.admin_cleanup.get_db")
    async def test_cleanup_extract_company_from_title(
        self, mock_get_db, client, mock_db
    ):
