...
class ProfileAutoFillService:
    ...
    async def extract_profile_from_cv(
        self, file_content: bytes, filename: str, user: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _enhance_with_ai(
        self, parsed_data: Dict[str, Any], user: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await openai.ChatCompletion.acreate(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a professional CV parser specializing in profile data extraction. Return only valid JSON.",
                    },
    ...
    def _format_linkedin_for_profile(
...
async def auto_fill_from_cv(
    ...
    try:
        ...
        result = await profile_service.extract_profile_from_cv(
            file_content, file.filename, user
        )
