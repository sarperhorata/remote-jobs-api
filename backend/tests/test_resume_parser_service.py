...
class TestResumeParserService:
    ...
    def test_parse_resume_pdf(self, parser, sample_pdf_content):
        ...
        with patch.object(parser, '_extract_text_from_pdf', return_value="Sample content"):
    ...
    def test_parse_resume_docx(self, parser, sample_docx_content):
        ...
        with patch.object(parser, '_extract_text_from_docx', return_value="Sample content"):
    ...
    def test_education_degree_extraction(self, parser):
        ...
        for edu in education:
            if 'degree' in edu:
                assert 'master' in edu['degree'].lower() or 'bachelor' in edu['degree'].lower()