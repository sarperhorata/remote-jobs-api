...
class TestJobMatchingService:
    ...
    def test_calculate_matching_score(self, matcher, sample_resume_data, sample_job_data):
    ...
    def test_calculate_skill_matching(self, matcher, sample_resume_data, sample_job_data):
    ...
    def test_calculate_experience_matching(self, matcher, sample_resume_data, sample_job_data):
        """Test experience matching calculation"""
        score = matcher._calculate_experience_matching(sample_resume_data, sample_job_data)
    ...
    def test_calculate_location_matching(self, matcher, sample_resume_data, sample_job_data):
        """Test location matching calculation"""
        score = matcher._calculate_location_matching(sample_resume_data, sample_job_data)
    ...
    def test_calculate_location_matching_different_locations(self, matcher, sample_resume_data):
    ...
    def test_calculate_education_matching(self, matcher, sample_resume_data, sample_job_data):
        """Test education matching calculation"""
        score = matcher._calculate_education_matching(sample_resume_data, sample_job_data)
    ...
    def test_get_top_matches(self, matcher, sample_resume_data):
        ...
        matches = matcher.get_top_matches(sample_resume_data, jobs_data, limit=2, min_score=0.3)
    ...
    def test_get_resume_recommendations(self, matcher, sample_resume_data):
        ...
        recommendations = matcher.get_resume_recommendations(sample_resume_data, jobs_data, limit=5)
    ...
    def test_skill_matching_with_no_requirements(self, matcher, sample_resume_data):
        ...
        score = matcher._calculate_skill_matching(sample_resume_data, job_no_requirements)
    ...
    def test_location_matching_with_missing_location(self, matcher, sample_resume_data):
        ...
        score = matcher._calculate_location_matching(sample_resume_data, job_no_location)
