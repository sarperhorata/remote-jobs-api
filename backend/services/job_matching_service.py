...
class JobMatchingService:
    ...
    def calculate_matching_score(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            experience_score = self._calculate_experience_matching(resume_data, job_data)
    ...
    def _calculate_skill_matching(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> float:
        ...
        for category, weight in self.skill_weights.items():
            ...
            if job_category_requirements:
                ...
                matching_skills = resume_category_skills.intersection(job_category_requirements)
                
                # Calculate score based on matching percentage
                if job_category_requirements:
                    category_score = len(matching_skills) / len(job_category_requirements)
    ...
    def _calculate_experience_matching(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> float:
    ...
    def _calculate_location_matching(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> float:
        """Calculate location matching score"""
        resume_location = resume_data.get('personal_info', {}).get('location', '').lower()
    ...
    def _calculate_salary_matching(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> float:
    ...
    def _calculate_education_matching(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> float:
    ...
    def _get_matching_details(self, resume_data: Dict[str, Any], job_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'skill_coverage': len(matching_skills) / len(job_requirements) if job_requirements else 0
        }

    def get_top_matches(self, resume_data: Dict[str, Any], jobs_data: List[Dict[str, Any]], 
                       limit: int = 10, min_score: float = 0.3) -> List[Dict[str, Any]]:
        """
    ...
    def get_resume_recommendations(self, resume_data: Dict[str, Any], jobs_data: List[Dict[str, Any]], 
    ...
    def _analyze_skill_gaps(self, resume_data: Dict[str, Any], jobs_data: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _get_most_demanded_skills(self, jobs_data: List[Dict[str, Any]]) -> Dict[str, int]:
    ...
    def _get_industry_insights(self, resume_data: Dict[str, Any], jobs_data: List[Dict[str, Any]]) -> Dict[str, Any]:
