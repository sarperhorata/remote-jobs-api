...
try:
    from models.models import (JobType, UserNotificationPreference,
                               UserProfile, UserProfileCreate,
                               UserProfileUpdate, WorkHours, WorkType)
except ImportError:
...
class RemoteJobsBot:
    ...
    def __init__(self):
        ...
        if not TELEGRAM_ENABLED:
            logger.warning(
                "Telegram bot is disabled. Set TELEGRAM_BOT_TOKEN environment variable to enable it."
            )
            self.enabled = False
            ...
            states={
                PROFILE_MENU: [
                    CallbackQueryHandler(
                        self.create_profile, pattern="^create_profile$"
                    ),
                ...
                FIRST_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, self.get_first_name)
                ],
                LAST_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, self.get_last_name)
                ],
                EMAIL: [
                ...
                LOCATION: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, self.get_location)
                ],
                BIO: [MessageHandler(filters.TEXT & ~filters.COMMAND, self.get_bio)],
                WORK_PREFERENCES: [
                    CallbackQueryHandler(
                        self.get_work_preferences, pattern="^set_work_preferences$"
                    ),
                    CallbackQueryHandler(
                        self.skip_work_preferences, pattern="^skip_work_preferences$"
                    ),
                ],
                WORK_TYPE: [
                ...
                JOB_TYPE: [
                    CallbackQueryHandler(
                        self.get_job_type_full_time, pattern="^full_time$"
                    ),
                    CallbackQueryHandler(
                        self.get_job_type_part_time, pattern="^part_time$"
                    ),
                    CallbackQueryHandler(
                        self.get_job_type_contract, pattern="^contract$"
                    ),
                    CallbackQueryHandler(
                        self.get_job_type_freelance, pattern="^freelance$"
                    ),
                    CallbackQueryHandler(
                        self.get_job_type_internship, pattern="^internship$"
                    ),
                    CallbackQueryHandler(self.get_job_type_any, pattern="^any$"),
                ],
                SKILL_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, self.get_skill_name)
                ],
                SKILL_LEVEL: [
                    CallbackQueryHandler(
                ...
                SKILL_EXPERIENCE: [
                    MessageHandler(
                        filters.TEXT & ~filters.COMMAND, self.get_skill_experience
                    )
                ],
                ADD_MORE_SKILLS: [
                    CallbackQueryHandler(
                        self.add_more_skills, pattern="^add_more_skills$"
                    ),
            ...
            await update.message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "View Profile", callback_data="show_profile"
                            )
                        ],
                        [
                            InlineKeyboardButton(
                        ...
                        [
                            InlineKeyboardButton(
                                "Browse Jobs", callback_data="browse_jobs"
                            )
                        ],
                    ]
                ),
        ...
        await update.message.reply_html(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "📋 Tüm İşleri Görüntüle", callback_data="browse_all_jobs"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "🎯 Uygun İşleri Görüntüle",
                            callback_data="browse_matching_jobs",
                        )
                    ],
        ...
        await update.message.reply_html(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "📅 Günlük Uyarılar", callback_data="subscribe_daily"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "📊 Haftalık Özet", callback_data="subscribe_weekly"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "⚡ Gerçek Zamanlı Uyarılar (Premium)",
                            callback_data="subscribe_realtime",
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "🚫 Aboneliği İptal Et", callback_data="unsubscribe"
                        )
                    ],
                ]
            ),
    ...
    async def profile_start(
        ...
        if user_profile:
            buttons.extend(
                [
                    [
                        InlineKeyboardButton(
                            "👁️ Profili Görüntüle", callback_data="show_profile"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "✏️ Profili Düzenle", callback_data="edit_profile"
                        )
                    ],
                ]
            )
            ...
            buttons.append(
                [
                    InlineKeyboardButton(
                        "➕ Profil Oluştur", callback_data="create_profile"
                    )
                ]
            )
        ...
        await update.message.reply_html(
            "👤 <b>Profil Yönetimi:</b>", reply_markup=InlineKeyboardMarkup(buttons)
        )
    ...
    async def get_phone(
        ...
        if update.message.text == "/skip":
            await update.message.reply_text(
                "No problem! Let's move on.", reply_markup=ReplyKeyboardRemove()
            )
        else:
    ...
    async def get_bio(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
        ...
        if update.message.text == "/skip":
            ...
            await update.message.reply_text(
                "Bio saved!", reply_markup=ReplyKeyboardRemove()
            )
        ...
        await update.message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "Set Preferences", callback_data="set_work_preferences"
                        )
                    ],
                    [
                        InlineKeyboardButton(
                            "Skip for Now", callback_data="skip_work_preferences"
                        )
                    ],
                ]
            ),
    ...
    async def get_skill_experience(
        ...
        try:
            ...
            context.user_data["profile"]["skills"].append(
                context.user_data["temp_skill"]
            )
            ...
            await update.message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Add Another Skill", callback_data="add_more_skills"
                            )
                        ],
                        [
                            InlineKeyboardButton(
                                "I'm Done", callback_data="finish_skills"
                            )
                        ],
                    ]
                ),
    ...
    async def skip_work_preferences(
        self, update: Update, context: ContextTypes.DEFAULT_TYPE
    ) -> int:
    ...
    async def show_profile(
        ...
        if user_profile.work_preferences:
            ...
            if wp.job_type:
                profile_text += (
                    f"- Job Type: {wp.job_type.value.replace('_', ' ').capitalize()}\n"
                )
        ...
        if user_profile.skills and len(user_profile.skills) > 0:
            ...
            for skill in user_profile.skills:
                exp_text = (
                    ...
                    if skill.years_experience and skill.years_experience > 0
                    else ""
                )
                profile_text += (
                    f"- {skill.name}: {skill.level.value.capitalize()} {exp_text}\n"
                )
        ...
        await query.edit_message_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "Create New Profile", callback_data="create_profile"
                        )
                    ],
                    [InlineKeyboardButton("Cancel", callback_data="cancel")],
                ]
    ...
    async def cancel_profile(
        ...
        if update.callback_query:
            ...
            await update.message.reply_text(
                "Profile management canceled.", reply_markup=ReplyKeyboardRemove()
            )
    ...
    def run(self):
        ...
        if not self.enabled or not self.application:
            logger.warning(
                "Cannot run Telegram bot: bot is disabled or not properly initialized"
            )
            return
    ...
    async def send_deployment_notification(
        ...
        try:
            ...
            if not notification_chat_id:
                logger.warning(
                    "TELEGRAM_CHAT_ID not set, cannot send deployment notification"
                )
                return False
            ...
            try:
                ...
                logger.info(
                    f"Deployment notification sent successfully to chat {notification_chat_id}"
                )
                return True
    ...
    def _format_deployment_message(self, data: Dict[str, Any]) -> str:
        ...
        status_emoji = (
            ...
            else "⚠️" if data.get("status") == "warning" else "❌"
        )
        ...
        if data.get("status") == "success":
            message += (
                f"Buzz2Remote backend servisi başarıyla deploy edildi ve çalışıyor.\n\n"
            )
        else:
    ...
    def _format_distill_crawl_message(self, data: Dict[str, Any]) -> str:
        ...
        if data.get("status") == "success":
            message += (
                f"🏢 <b>Bulunan Şirketler:</b> {data.get('companies_found', 0):,}\n"
            )
        ...
        if data.get("status") == "success":
            message += (
                f"Distill crawler başarıyla çalıştı ve yeni veriler toplandı.\n\n"
            )
        else:
    ...
    def _format_generic_message(self, data: Dict[str, Any]) -> str:
        ...
        status_text = (
            "BAŞARILI"
            if data.get("status") == "success"
            else "UYARI" if data.get("status") == "warning" else "HATA"
        )
    ...
    async def send_error_notification(
        self, message: str, error_data: Dict[str, Any] = None
    ) -> bool:
        """
        ...
        try:
            ...
            if not notification_chat_id:
                logger.warning(
                    "TELEGRAM_CHAT_ID not set, cannot send error notification"
                )
                return False
            ...
            try:
                ...
                logger.info(
                    f"Error notification sent successfully to chat {notification_chat_id}"
                )
                return True
    ...
    async def send_new_job_notification(self, job_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if not notification_chat_id:
                logger.warning(
                    "TELEGRAM_CHAT_ID not set, cannot send new job notification"
                )
                return False
            ...
            try:
                await self.application.bot.send_message(
                    chat_id=notification_chat_id, text=message, parse_mode="HTML"
                )
                logger.info(
                    f"New job notification sent successfully to chat {notification_chat_id}"
                )
                return True
    ...
    async def send_crawler_notification(self, crawler_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            status_text = (
                "BAŞARILI"
                if crawler_data.get("status") == "success"
                else "UYARI" if crawler_data.get("status") == "warning" else "HATA"
            )
            ...
            message += (
                f"🔧 <b>Servis:</b> {crawler_data.get('service', 'Bilinmiyor')}\n"
            )
            message += f"📊 <b>Durum:</b> {status_text}\n"
            ...
            if (
                "disabled_endpoints" in crawler_data
                and crawler_data["disabled_endpoints"]
            ):
            ...
            if not notification_chat_id:
                logger.warning(
                    "TELEGRAM_CHAT_ID not set, cannot send crawler notification"
                )
                return False
            ...
            try:
                ...
                logger.info(
                    f"Crawler notification sent successfully to chat {notification_chat_id}"
                )
                return True
    ...
    try:
        ...
        profile_conv_handler = ConversationHandler(
            ...
            states={
                PROFILE_MENU: [
                    CallbackQueryHandler(
                        bot.create_profile, pattern="^create_profile$"
                    ),
                ...
                FIRST_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, bot.get_first_name)
                ],
                LAST_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, bot.get_last_name)
                ],
                ...
                LOCATION: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, bot.get_location)
                ],
                BIO: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot.get_bio)],
                WORK_PREFERENCES: [
                    CallbackQueryHandler(
                        bot.get_work_preferences, pattern="^set_work_preferences$"
                    ),
                    CallbackQueryHandler(
                        bot.skip_work_preferences, pattern="^skip_work_preferences$"
                    ),
                ],
                WORK_TYPE: [
                ...
                JOB_TYPE: [
                    CallbackQueryHandler(
                        bot.get_job_type_full_time, pattern="^full_time$"
                    ),
                    CallbackQueryHandler(
                        bot.get_job_type_part_time, pattern="^part_time$"
                    ),
                    CallbackQueryHandler(
                        bot.get_job_type_contract, pattern="^contract$"
                    ),
                    CallbackQueryHandler(
                        bot.get_job_type_freelance, pattern="^freelance$"
                    ),
                    CallbackQueryHandler(
                        bot.get_job_type_internship, pattern="^internship$"
                    ),
                    CallbackQueryHandler(bot.get_job_type_any, pattern="^any$"),
                ],
                SKILL_NAME: [
                    MessageHandler(filters.TEXT & ~filters.COMMAND, bot.get_skill_name)
                ],
                SKILL_LEVEL: [
                    CallbackQueryHandler(
                        bot.get_skill_level,
                ...
                SKILL_EXPERIENCE: [
                    MessageHandler(
                        filters.TEXT & ~filters.COMMAND, bot.get_skill_experience
                    )
                ],
                ADD_MORE_SKILLS: [
                    CallbackQueryHandler(
                        bot.add_more_skills, pattern="^add_more_skills$"
                    ),
