...
class TestSalaryPredictionService:
    ...
    def test_calculate_base_salary(self, predictor, sample_resume_data, sample_job_data):
        """Test base salary calculation"""
        base_salary = predictor._calculate_base_salary(sample_resume_data, sample_job_data)
    ...
    def test_determine_experience_level(self, predictor, sample_resume_data, sample_job_data):
        """Test experience level determination"""
        level = predictor._determine_experience_level(sample_resume_data, sample_job_data)
        
        assert level in ['entry', 'junior', 'mid', 'senior', 'lead', 'manager', 'director', 'executive']
    ...
    def test_apply_multipliers(self, predictor, sample_resume_data, sample_job_data):
        ...
        adjusted_salary = predictor._apply_multipliers(base_salary, sample_resume_data, sample_job_data)
    ...
    def test_calculate_confidence(self, predictor, sample_resume_data, sample_job_data):
        ...
        confidence = predictor._calculate_confidence(sample_resume_data, sample_job_data)
    ...
    def test_generate_market_comparison_with_data(self, predictor):
        ...
        comparison = predictor._generate_market_comparison(predicted_salary, market_data)
    ...
    def test_get_industry_impact(self, predictor):
        ...
        job_data = {
            'title': 'Fintech Developer',
            'description': 'Working in fintech'
        }
    ...
    def test_analyze_location_salaries(self, predictor):
        ...
        predictions = [
            {
                'location': 'San Francisco, CA',
                'predicted_salary': {'avg': 120000}
            },
            {
                'location': 'Remote',
                'predicted_salary': {'avg': 90000}
            },
            {
                'location': 'San Francisco, CA',
                'predicted_salary': {'avg': 130000}
            }
        ]
