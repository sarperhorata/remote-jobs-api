...
class TestTranslationRoutes:
    ...
    def test_translate_job_success(
        self, mock_translate, client: TestClient, auth_headers
    ):
    ...
    def test_auto_translate_new_jobs_success(
        self, mock_batch_translate, client: TestClient, auth_headers
    ):
    ...
    @patch("services.translation_service.TranslationService.translate_job")
    def test_translate_job_already_translated(
        self, mock_translate, client: TestClient, auth_headers
    ):
    ...
    @patch("services.translation_service.TranslationService.translate_job")
    def test_translate_job_error_handling(
        self, mock_translate, client: TestClient, auth_headers
    ):
    ...
    def test_translate_job_invalid_job_id_format(
    ...
    @patch("services.translation_service.TranslationService.batch_translate_jobs")
    def test_auto_translate_batch_processing(
        self, mock_batch_translate, client: TestClient, auth_headers
    ):
