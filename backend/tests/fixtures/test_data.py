...
def realistic_jobs_data():
    ...
    return [
        ...
        },
        {
            ...
            "skills": ["Python", "R", "Machine Learning", "Deep Learning", "SQL", "Statistics"],
            "experience_level": "Senior",
            "work_type": "Office"
        },
        {
...
def mock_jobs_collection_with_data(realistic_jobs_data):
    ...
    collection.find_one = AsyncMock(side_effect=lambda *args, **kwargs: 
    ...
    collection.aggregate = AsyncMock(return_value=AsyncMock(to_list=AsyncMock(return_value=realistic_jobs_data)))
...
@pytest.fixture
def mock_database_with_realistic_data(mock_jobs_collection_with_data, mock_companies_collection_with_data, mock_users_collection_with_data):
