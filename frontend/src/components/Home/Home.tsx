      ...
      if (jobs.length > 0) {
        ...
        setHotJobs([
          ...
          },
          {
            ...
            companyId: '6',
            company: { _id: '6', id: '6', name: 'Hugging Face', logo: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
          ...
          },
          {
            ...
            companyId: '7',
            company: { _id: '7', id: '7', name: 'Vercel', logo: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
          ...
          },
          {
            ...
            title: 'Data Engineer',
            companyId: '8',
            company: { _id: '8', id: '8', name: 'Snowflake', logo: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
          ...
          },
          {
            ...
            companyId: '9',
            company: { _id: '9', id: '9', name: 'CrowdStrike', logo: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
          ...
          },
          {
            ...
            companyId: '10',
            company: { _id: '10', id: '10', name: 'Supabase', logo: '', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
