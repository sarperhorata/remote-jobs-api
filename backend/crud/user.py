...
from backend.schemas.user import UserCreate, UserInDB, UserResponse, UserUpdate
...
async def get_user_by_telegram_id(
    db: AsyncIOMotorDatabase, telegram_user_id: int
...
async def update_user(
    db: AsyncIOMotorDatabase, user_id: str, user: UserUpdate
) -> Optional[UserResponse]:
    """Update a user."""
    if not ObjectId.is_valid(user_id):
        return None
